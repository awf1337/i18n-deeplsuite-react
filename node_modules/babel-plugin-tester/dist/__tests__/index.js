...
_asyncToGenerator(function* () {
  yield runPluginTester(getOptions({
    ...
    tests: [{
      code: 'var foo = "";\nvar bar = "";',
      output: `var foo = "";${_os.EOL}var bar = "";`
    }]
  }));
}));
test('endOfLine - preserve',
/*#__PURE__*/
_asyncToGenerator(function* () {
  yield runPluginTester(getOptions({
    endOfLine: 'preserve',
...
test('endOfLine - preserve - no linefeed',
/*#__PURE__*/
_asyncToGenerator(function* () {
  yield runPluginTester(getOptions({
    endOfLine: 'preserve',
